...
class PartidoController extends Controller
{
    ...
    /**
     * @Route("/{slug}.html", name="app_partidos_index")
    ...
    /**
     * @Route("/upload", name="app_partido_upload")
     */
    public function uploadAction(Request $request)
    {
        ...
        if ($request->getMethod() == Request::METHOD_POST) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirectToRoute('app_partidos_index');
            }
        }

        return $this->render(':partido:upload.html.twig', [
    ...
    public function insertPartidoAction($id, Request $request)
    {
        ...
        if ($request->getMethod() == Request::METHOD_POST) {
            ...
            if ($form->isValid()) {
                ...
                $m->persist($c);
                $m->flush();
                return $this->redirectToRoute('app_partidos_index', ['slug' => $id]);
            }
        }
    ...
    public function removePartidoAction($id)
    {
        ...
        $m->remove($partido);
        $m->flush();
        return $this->redirectToRoute('app_partidos_index',array('slug' => $equipoid));
    ...
    /**
     * @Route("showPartido/{slug}.html", name="app_partido_show")
     */
    public function showPartidoAction($slug)
    {
        ...
        return $this->render(':partido:partidovist.html.twig', [
            'partido'   => $partido,
        ]);
    }
//app_partido_play
